...
func (gw2 *GW2Api) CommerceListingIds(ids ...uint32) (articles []messages.Listings, err error) {
	ver := "v2"
	tag := "commerce/listings"
	params := url.Values{}
...
func (gw2 *GW2Api) CommerceListingPages(page int, pageSize int) (res []messages.Listings, err error) {
	if page < 0 {
...
func (gw2 *GW2Api) CommercePriceIds(ids ...uint32) (artprices []messages.Prices, err error) {
	ver := "v2"
	tag := "commerce/prices"
	params := url.Values{}
	params.Add("ids", commaListUint32(ids))
...
// CommerceListingPages for paginating through all existing listings
func (gw2 *GW2Api) CommercePricePages(page uint32, pageSize uint32) (res []messages.Prices, err error) {
	ver := "v2"
	tag := "commerce/prices"
	params := url.Values{}
