...
func (gw2 *GW2Api) GuildUpgrades() (res []uint32, err error) {
	ver := "v2"
	tag := "guild/upgrades"
	err = gw2.fetchEndpoint(ver, tag, nil, &res)
	return
...
func (gw2 *GW2Api) GuildUpgradeIds(lang string, ids ...uint32) (guild []GuildUpgrade, err error) {
	ver := "v2"
	tag := "guild/upgrades"
	params := url.Values{}
	if lang != "" {
...
func (gw2 *GW2Api) GuildEmblems() (foreground []uint32, background []uint32, err error) {
	ver := "v2"
...
func (gw2 *GW2Api) GuildEmblemForegroundIds(ids ...uint32) (layers []EmblemLayers, err error) {
	ver := "v2"
	tag := "emblem/foregrounds"
	params := url.Values{}
	params.Add("ids", commaListUint32(ids))
...
func (gw2 *GW2Api) GuildEmblemBackgroundIds(ids ...uint32) (layers []EmblemLayers, err error) {
	ver := "v2"
	tag := "emblem/backgrounds"
	params := url.Values{}
	params.Add("ids", commaListUint32(ids))
