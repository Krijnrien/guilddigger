...
func (gw2 *GW2Api) ItemDetails(page int, pageSize int, lang string, ids ...uint32) ([]Item, error) {
	if ids != nil {
...
func (gw2 *GW2Api) ItemIds(lang string, ids ...uint32) (items []Item, err error) {
	ver := "v2"
	tag := "items"
	params := url.Values{}
	if lang != "" {
