...
func (gw2 *GW2Api) Achievements() (res []uint32, err error) {
	ver := "v2"
	tag := "achievements"
...
func (gw2 *GW2Api) AchievementIds(lang string, ids ...uint32) (achievs []Achievement, err error) {
	ver := "v2"
	tag := "achievements"
	params := url.Values{}
	if lang != "" {
...
func (gw2 *GW2Api) AchievementCategories() (res []uint32, err error) {
	ver := "v2"
...
func (gw2 *GW2Api) AchievementCategoryIds(lang string, ids ...uint32) (achievs []AchievementCategory, err error) {
	ver := "v2"
	tag := "achievements/categories"
	params := url.Values{}
	if lang != "" {
